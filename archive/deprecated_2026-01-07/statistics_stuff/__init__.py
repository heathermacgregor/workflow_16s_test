...
# Local Imports
from workflow_16s.downstream.statistics.tests import (
    anova, enhanced_statistical_tests, fisher_exact_bonferroni, kruskal_bonferroni, 
    mwu_bonferroni, ttest, spearman_correlation
)
from workflow_16s.downstream.statistics.advanced_analyses import (
    core_microbiome, differential_abundance_analysis, microbial_network_analysis
)
...
def run_single_statistical_test(
    ...
    try:
        # Prepare data once
        table, metadata = sync_samples(table, metadata)
