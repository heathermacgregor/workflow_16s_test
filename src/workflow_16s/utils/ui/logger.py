# workflow_16s/src/workflow_16s/utils/ui/logger.py
...
def with_logger(func_or_class):
    """
    A decorator that injects a logger instance into the decorated function or class constructor 
    if it accepts a 'logger' parameter or **kwargs.
    This allows for seamless logging integration without forcing all functions to accept a logger.
    """
