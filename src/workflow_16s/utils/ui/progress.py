# workflow_16s/src/workflow_16s/utils/ui/progress.py
...
DEFAULT_PROGRESS_TEXT_N: int = 65 # Total character width of the progress bar text
DEFAULT_N: int = 65 
DEFAULT_DESCRIPTION_STYLE: str = "white" # Color of the progress bar description text
DEFAULT_BAR_WIDTH: int = 40 # Width of the progress bar
DEFAULT_BAR_COLUMN_COMPLETE_STYLE: str = "honeydew2" # Color of the filled/complete portion of the progress bar
DEFAULT_FINISHED_STYLE: str = "dark_cyan"  # Color used when the progress bar is finished
DEFAULT_PROGRESS_PERCENTAGE_STYLE: str = "honeydew2" # Color of the percentage complete text (e.g., "85%")
DEFAULT_M_OF_N_COMPLETE_STYLE: str = "honeydew2" # Color of the "X of Y complete" text (e.g., "42 of 65")
DEFAULT_TIME_ELAPSED_STYLE: str = "light_sky_blue1" # Color of the time elapsed display (e.g., "E: 00:01:25")
DEFAULT_TIME_REMAINING_STYLE: str = "thistle1" # Color of the estimated time remaining display (e.g., "R: 00:00:34")
