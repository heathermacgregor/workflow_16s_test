# ==================================================================================== #
#                       api/nuclear_fuel_cycle/_gem.py
# ==================================================================================== #
...
class GNPT:
    ...
    def __init__(self, output_dir: Optional[Path] = None):
        ...
        logger.info(f"GEM database configured to use file: {self.file_path}")
    ...
    def load(self) -> pd.DataFrame:
        ...
        if not self.file_path.exists():
            try:
                logger.info(f"GEM database file not found at {self.file_path}. Downloading...")
                self._download()
            except Exception as e:
                logger.error(f"Failed to download GEM data: {e}")
                return pd.DataFrame()
        ...
        try:
            ...
            logger.info(f"Successfully loaded GEM data with {self.df.shape[0]} facilities.")
        except Exception as e:
            logger.error(f"Error loading GEM data from {self.file_path}: {e}")
            return pd.DataFrame()
    ...
    def _download(self):
        ...
        logger.info(f"Downloaded GEM database to {self.file_path}")