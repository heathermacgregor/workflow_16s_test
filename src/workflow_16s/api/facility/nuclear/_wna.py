# ==================================================================================== #
#                       api/nuclear_fuel_cycle/_wna.py
# ==================================================================================== #
...
class WNA:
    ...
    def load(self) -> pd.DataFrame:
        logger.info("Scraping WNA Uranium Mining data...")
        try:
            ...
            if target_df.empty:
                logger.warning("Could not find mining table in WNA page.")
                return pd.DataFrame()
            ...
            logger.error(f"WNA Scraper failed: {e}")
            return pd.DataFrame()