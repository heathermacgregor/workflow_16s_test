# workflow_16s/api/environmental_data/nuclear_fuel_cycle/tools/_jrc.py
...
class JRC:
    ...
    def load(self) -> pd.DataFrame:
        self.logger.info("Scraping JRC/Euratom Research Infrastructures...")
        try:
            ...
            self.logger.info(f"Loaded {len(df)} JRC facilities.")
            return df
