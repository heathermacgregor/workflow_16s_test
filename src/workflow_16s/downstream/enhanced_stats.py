...
from workflow_16s.downstream.effect_sizes import (
...
from workflow_16s.downstream.adata_utils import (
    fix_adata_dtypes,
    safe_write_h5ad
)
from workflow_16s.downstream.performance_optimizer import (
...
def check_and_correct_batch_effects(
    ...
    if method == 'percentile':
        ...
        corrected = conqur_batch_correction(
            adata,
            batch_col=batch_col,
